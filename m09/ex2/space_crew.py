...
if __name__ == "__main__":
    ...
    print(f"Mission: {ValidMission.mission_name}")
    print(f"ID: {ValidMission.mission_id}")
    print(f"Destination: {ValidMission.destination}")
    print(f"Duration: {ValidMission.duration_days} days")
    print(f"Budget: ${ValidMission.budget_millions}M")
    print(f"Crew size: {len(ValidMission.crew)}")
    print("Crew members:")
    for member in ValidMission.crew:
